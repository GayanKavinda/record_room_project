                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm text-gray-500">{{ $log->user ? $log->user->name : 'N/A' }}</span>
                                        </div>
                                    </td>
                ...
                <div class="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
                    ...
                    <div class="flex space-x-2">
                        @if ($logs->previousPageUrl())
                            <a href="{{ $logs->previousPageUrl() }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors flex items-center">
                        ...
                        @endif
                        @if ($logs->nextPageUrl())
                            <a href="{{ $logs->nextPageUrl() }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors flex items-center">
                                Next
