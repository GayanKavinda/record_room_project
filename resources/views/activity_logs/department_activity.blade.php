                        ...
                        @foreach($activities as $activity)
                            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4 whitespace-wrap">
                                    <span class="text-sm text-gray-500">{{ $activity->details }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-600">{{ $activity->created_at->format('Y-m-d H:i:s') }}</span> <!-- Use the correct timestamp -->
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-600">{{ $activity->user->name }}</span> <!-- Assuming the 'user' relationship is correctly defined -->
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
