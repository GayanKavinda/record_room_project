            ...
            <form action="{{ url('users/'.$user->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="employee_id" class="block mt-1 w-full" type="text" name="employee_id" value="{{ $user->employee_id}}" required autofocus />
                    ...
                    <div>
                        ...
                        @error('name') <span class="text-blue-600">{{ $message }}</span> @enderror
                    </div>

                    <!-- NIC -->
                    <div>
                        <x-input-label for="nic" :value="__('National Identity Card No')" />
                        <x-text-input id="nic" class="block mt-1 w-full" type="text" name="nic" value="{{ $user->nic}}" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <select id="join_or_transfer" name="join_or_transfer" class="block mt-1 w-full rounded-lg" value="{{ $user->join_or_transfer}}" required>
